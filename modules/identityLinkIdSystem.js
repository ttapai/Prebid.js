...
export const identityLinkSubmodule = {
  ...
  getId(config, consentData) {
    ...
    const gppSectionId = gppData && gppData.gppString && gppData.applicableSections.length > 0 ? gppData.applicableSections[0] : false;
    const hasGpp = gppData && gppData.ready && gppString && gppSectionId;
